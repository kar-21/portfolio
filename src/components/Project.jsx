          ...
          >
            <Card className={classes.card}>
              ...
              <CardContent className={classes.cardContent}>
                ...
                />
                <p>
                  A system for staffs & admin to manage passengers while
                  check-in and in-flight built using angular, express.js &
                  MongoDB. Used concepts like Oauth2, NgRx, jwt & cookies.
                </p>
              </CardContent>
            </Card>
          </a>
          ...
          >
            <Card className={classes.card}>
              ...
              <CardContent className={classes.cardContent}>
                ...
                <p>
                  A tracker to display number of Covid cases in India built
                  using React and D3.js.The data is fetched from open source API
                  and it is parsed in UI to readable formate with options like
                  donut graph, sort & state wise grouping.
                </p>
              </CardContent>
            </Card>
          </a>
